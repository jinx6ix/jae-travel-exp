...
export const InfiniteMovingCard = ({
  ...
  return (
    <><h3 className='TestimonialHeader'>Reviews</h3><div
      ref={containerRef}
      className={cn(
    ...
    >
      ...
      >
        {items?.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-1 py-3 md:w-[450px]"
            style={{
              background: "linear-gradient(180deg, #de6c2a, #b5b4b0)",
              color: "black",
              listStyle: "none",
              textDecoration: "none",
            }}
